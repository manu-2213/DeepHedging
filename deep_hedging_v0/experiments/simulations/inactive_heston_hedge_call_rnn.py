...
from experiments.utils.actor_inactor_rnn import generate_actor_inactor_rnn
...
def main():
    ...
    feature_dim = 11  # Heston model feature dimension
    ...
    action_model, inaction_model = generate_actor_inactor_rnn(
